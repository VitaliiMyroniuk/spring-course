...
import beans.configuration.TestAuditoriumConfiguration;
...
@ContextConfiguration(classes = {AppConfiguration.class, DataSourceConfiguration.class, DbSessionFactory.class, TestAuditoriumConfiguration.class})
@Transactional
